      ...
      <div>
        <Link href={{ pathname: '/product', query: { _id: item?._id } }}>
          <div className="w-full h-96 group overflow-hidden relative">
            ...
            />
            {item?.isNew && (
              <span className="absolute top-2 right-2 font-medium text-xs py-1 px-3 rounded-full bg-white group-hover:text-white group-hover:bg-orange-600 duration-200 ">
                New Arrival
              </span>
            )}
          </div>
